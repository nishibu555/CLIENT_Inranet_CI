    ...
    $.fn.fcbkcomplete = function(opt) {
        return this.each(function() {
            ...
            function addMembers(etext, data) {
                ...
                match;
                try{
                    //myregexp = eval('/(?:^|;)\\s*(\\d+)\\s*:[^;]*?' + etext + '[^;]*/g' + filter); // MARK MARK MARK
                ...
                while (match != null && maximum > 0) {
                    ...
                    if (options.filter_selected && element.children("option[value=" + object.value + "]").hasClass("selected")) {
                        ...
                        content += '<li rel="' + object.value + '">' + itemIllumination(object.key, etext).substr(1) + '</li>';
                        counter++;
                        maximum--;
                    }
                    match = myregexp.exec(search_string);
            ...
            var options = $.extend({
                ...
                complete_text: "Start typing students to tag...",
                maxshownitems: 30,
                maxitems: 50,
                onselect: null,
                onremove: null,
