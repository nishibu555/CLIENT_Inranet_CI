        ...
        <div class="col-md-9">
            <div class="student_academic_history">
                ...
                <div class="student_contract">
                    <p style="margin-top: 6px">ACADEMICS / NEW CONTRACT</p>
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <th style="border-top: 1px solid #0F3A64;border-bottom: 1px solid #0F3A64">
                                ...
                                <p class="common-style-p" style="font-size: 11px;">Entry date: <?php echo date("m/d/y", strtotime(@$contract_info->doe)) ?></p>
                            </th>
                            <th style="border-top: 1px solid #0F3A64;border-bottom: 1px solid #0F3A64">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if (@$contract_info->status != 'Completed'){?>
                                    <button type="button" class="btn btn-primary btn-sm contract-btn" id="due_date">Edit</button>
                                <?php }?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if (@$contract_info->status != 'Completed'){?>
                                    <button type="button" class="btn btn-primary btn-sm contract-btn" id="unit_title">Edit</button>
                                <?php }?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if (@$contract_info->status != 'Completed'){?>
                                    <button type="button" class="btn btn-primary btn-sm contract-btn" id="major_theme">Edit</button>
                                <?php }?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if (@$contract_info->status != 'Completed'){?>
                                    <button type="button" class="btn btn-primary btn-sm contract-btn" id="minor_theme">Edit</button>
                                <?php }?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if (@$contract_info->status != 'Completed'){?>
                                    <button type="button" class="btn btn-primary btn-sm contract-btn" id="Goals">Edit</button>
                                <?php }?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if (@$contract_info->status != 'Completed'){?>
                                    <button type="button" class="btn btn-primary btn-sm contract-btn" id="lessons">Edit</button>
                                <?php }?>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if (@$contract_info->status != 'Completed'){?>
                                    <button type="button" class="btn btn-primary btn-sm contract-btn" id="scripture">Edit</button>
                                <?php }?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if (@$contract_info->status != 'Completed'){?>
                                    <button type="button" class="btn btn-primary btn-sm contract-btn" id="scripture_projects">Edit</button>
                                <?php }?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if (@$contract_info->status != 'Completed'){?>
                                    <button type="button" class="btn btn-primary btn-sm contract-btn" id="character">Edit</button>
                                <?php }?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if (@$contract_info->status != 'Completed'){?>
                                    <button type="button" class="btn btn-primary btn-sm contract-btn" id="character_projects">Edit</button>
                                <?php }?>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if (@$contract_info->status != 'Completed'){?>
                                    <button type="button" class="btn btn-primary btn-sm contract-btn" id="personal_reading">Edit</button>
                                <?php }?>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if (@$contract_info->status != 'Completed'){?>
                                    <button type="button" class="btn btn-primary btn-sm contract-btn" id="bible_reading">Edit</button>
                                <?php }?>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if (@$contract_info->status != 'Completed'){?>
                                    <button type="button" class="btn btn-primary btn-sm contract-btn" id="special_projects">Edit</button>
                                <?php }?>
                            </td>
                            <td></td>
                        </tr>
