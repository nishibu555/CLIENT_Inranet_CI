<div class="container">
			...
			<div class="sub_nav">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active"><a href="<?= base_url('') ?>">Add New Business</a></li>
					</ol>
				</nav>
			</div>
		</div>
	...
	<div class="row">
		...
		<div class="col-md-9">
			...
			<div>
				<form class="add_church" id="add_business">
					<div class="row">
						...
						<div class="col-md-6">
	                        ...
	                        <div class="form-group row">
	                            ...
	                            <div class="col-sm-8">
	                                <input type="text" class="form-control" name="altcontact" >
	                            </div>
	                        </div>
	                        <div class="form-group row">
	                        ...
	                        <div class="form-group row">
	                            ...
	                            <div class="col-sm-8">
	                                <input type="text" class="form-control" name="altemail" >
	                            </div>
	                        </div>
...
<script>
        ...
        $("#add_business").validate({
            submitHandler: function () {
                ...
                var value = $('#add_business').serialize();
          
	            $.ajax({
	                    method:'POST',
	                    data:value,
	                    url:'<?php echo base_url('save_business') ?>',
