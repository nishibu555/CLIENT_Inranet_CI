<div class="container">
			...
			<div class="sub_nav">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active"><a href="<?= base_url('') ?>">Update Business</a></li>
					</ol>
				</nav>
			</div>
		</div>
	...
	<div class="row">
		...
		<div class="col-md-9">
			...
			<div>
				<form class="add_church" id="update_business">
					<div class="row">
						<div class="col-md-6"><div class="form-group row">
                            <label class="col-md-4 col-form-label">Company:</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="<?= $business->company ?>" name="company" required>
                                <span class="company"></span>
                            </div>
	                        </div>
	                        <div class="form-group row">
	                            <label class="col-md-4 col-form-label">Business Type:</label>
	                            <div class="col-sm-8">
	                                <input type="text" class="form-control" value="<?= $business->bustype ?>" name="bustype" required>
	                                <span class="bustype"></span>
	                            </div>
	                        </div>
	                        <div class="form-group row">
	                            <label class="col-md-4 col-form-label">Address Line 1:</label>
	                            <div class="col-sm-8">
	                                <input type="text" class="form-control" value="<?= $business->addr1 ?>" name="addr1" >
	                            </div>
	                        </div>
	                        <div class="form-group row">
	                            <label class="col-md-4 col-form-label">Address Line 2:</label>
	                            <div class="col-sm-8">
	                                <input type="text" class="form-control" value="<?= $business->addr2 ?>" name="addr2" >
	                            </div>
	                        </div>
	                        <div class="form-group row">
	                        ...
	                        <div class="form-group row">
	                            ...
	                            <div class="col-sm-8">
	                                <input type="text" class="form-control" value="<?= $business->contact ?>" name="contact" >
	                            </div>
	                        </div>
	                        <div class="form-group row">
						...
						<div class="col-md-6">
	                        <div class="form-group row">
	                            ...
	                            <div class="col-sm-8">
	                                <input type="text" class="form-control" value="<?= $business->email ?>" name="email" >
	                            </div>
	                        </div>
	                        <div class="form-group row">
	                            <label class="col-md-4 col-form-label">District Mgr:</label>
	                            <div class="col-sm-8">
	                                <input type="text" class="form-control" value="<?= $business->altcontact ?>" name="altcontact" >
	                            </div>
	                        </div>
	                        <div class="form-group row">
	                            <label class="col-md-4 col-form-label">District Phone:</label>
	                            <div class="col-sm-8">
	                                <input type="text" class="form-control" value="<?= $business->altphone ?>" name="altphone" >
	                            </div>
	                        </div>
	                        <div class="form-group row">
	                            <label class="col-md-4 col-form-label">District E-mail:</label>
	                            <div class="col-sm-8">
	                                <input type="text" class="form-control" value="<?= $business->altemail ?>" name="altemail" >
	                            </div>
	                        </div>
	                        ...
	                        <div class="form-group row">
	                            ...
	                            <div class="col-sm-8">
	                                <textarea rows="4"  class="form-control"  name="notes" style="width: 100%"><?= $business->notes ?></textarea>
	                            </div>
	                        </div>
	                        <div class="form-group row">
					...
					<div class="row justify-content-center">
						<div class="col-md-4" style="text-align: center; margin: 20px 0px">
							...
							<button type="submit" class="btn btn-primary score-btn" style="width: 100%" id="add_business_btn">SAVE</button>
...
<script>
        ...
        $("#update_business").validate({
            submitHandler: function () {
                ...
                var value = $('#update_business').serialize();

	            $.ajax({
	                    method:'POST',
	                    data:value,
	                    url:"<?php  echo base_url().'update_business/'.$business->id ?>",
	                    success:function (data) {
	                        ...
	                        if (res.error_list){
	                        	...
	                        	window.location.href="<?=  base_url('marketing/business') ?>"
	                        }
	                    }
	             }); 
            }
