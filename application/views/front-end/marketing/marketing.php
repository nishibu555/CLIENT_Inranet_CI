<div class="container">
            ...
            <div class="sub_nav">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" ><a href="<?php echo base_url()?>marketing">Marketing</a></li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="side_div1">
                <p>MARKETING</p>
                <img style="width: 100%;" src="<?php echo base_url()?>assets/images/icon_marketing.png">
            </div>
