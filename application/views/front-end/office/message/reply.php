			...
			<div class="row">
				<div class="col-md-10">
			        ...
			        <div class="row justify-content-center">
			            ...
			            <input type="hidden" name="reply_id" value="<?= $previous_conversation->id ?>">
			        ...
			        <div style="margin-top: 20px; text-align: center;">
			        	<textarea rows="8"  name="message" style="width: 100%; text-align: left;">



_________________________________________________________
On <?= date('m/d/Y', strtotime($previous_conversation->timestamp)) ?>   at <?= date('h:i:sa', strtotime($previous_conversation->timestamp)) ?>, <?php echo  $previous_conversation->writter_fname." ".$previous_conversation->writter_lname ?> wrote:
...
<?= $previous_conversation->message ?>
			        	...
			        	<div>
			        		<button type="submit" class="btn btn-primary" style="padding: 5px 20px">Send Message</button>
